...
class PipelinedQueryExecutionContext {
    constructor(clientContext, collectionLink, query, options, partitionedQueryExecutionInfo, correlatedActivityId) {
        ...
        if (this.nonStreamingOrderBy) {
            ...
            if (Array.isArray(sortOrders) && sortOrders.length > 0) {
                ...
                //      "payload" property.
                this.endpoint = new OrderByEndpointComponent(new OrderByQueryExecutionContext(this.clientContext, this.collectionLink, this.query, this.options, this.partitionedQueryExecutionInfo, correlatedActivityId));
            }
            else {
    ...
    checkQueryConstraints(queryInfo) {
        ...
        if (!hasTop && !hasLimit) {
            throw new ErrorResponse("Executing a vector search query without TOP or LIMIT can consume a large number of RUs " +
...
function supportedQueryFeaturesBuilder(disableNonStreamingOrderByQuery) {
    ...
    if (disableNonStreamingOrderByQuery && disableListAndSetAggregate) {
        return Object.keys(QueryFeature)
            .filter((k) => k !== QueryFeature.NonStreamingOrderBy && k !== QueryFeature.ListAndSetAggregate)
            .join(", ");
    }
